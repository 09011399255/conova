...
import { seatSchema, SpaceSeatData } from "../../../../schemas/spaceSchema";
...
const AddSpacePage = () => {
    ...
    const onSubmit = (data: SpaceSeatData) => {
    ...
    const [previewData, setPreviewData] = useState<SpaceSeatData | null>(null);
