...
import { roomSchema, SpaceRoomData} from "../../../../schemas/spaceSchema";
...
const AddRoom = () => {
    ...
    const onSubmit = (data: SpaceRoomData) => {
    ...
    const [previewData, setPreviewData] = useState<SpaceRoomData | null>(null);
...
${errors.type
                        ...
                        />
                        {errors.type && <p className="text-[#EF4444] text-xs mt-[8px]">{errors.type.message}</p>}
                    </div>
...
${errors.number
                            ...
                            placeholder='e.g. "2"'
                        />
                        {errors.number && <p className="text-[#EF4444] text-xs mt-[8px]">{errors.number.message}</p>}
                    </div>
