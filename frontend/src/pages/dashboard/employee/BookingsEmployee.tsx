...
const BookingsEmployee = () => {
    ...
    const [activeTab, setActiveTab] = useState<"Upcoming(3)" | "Cancelled(5)" | "Past(10)">(() => {
        return (localStorage.getItem("spacesActiveTab") as "Upcoming(3)" | "Cancelled(5)" | "Past(10)") || "Upcoming(3)";
    });
                ...
                {["Upcoming(3)", "Cancelled(5)", "Past(10)"].map((tab) => {
                    ...
                    return (
                        <button
                            key={tab}
                            onClick={() => {
                                setActiveTab(tab as "Upcoming(3)" | "Cancelled(5)" | "Past(10)");
            ...
            <div className="mt-8">
                ...
                >
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between items-start mb-[25px]">
                                            <div>
                                                ...
                                                <p className="text-[12px] font-[500]">Schedule for {booking.date}</p>
                                            </div>
                                            ...
                                            {booking.type === "room" && (
                                                <div className="flex gap-2 items-center mr-[-20px]">
                                                    ...
                                                    <button>
                                                        <img src="/images/three.png" className="w-[80%]" alt="More options" />
                                                    </button>
                                                </div>
                                            )}
                                        ...
                                        <div className="block md:flex items-center justify-between">
                                            ...
                                            {booking.type === "room" && (
                                                <div
                                                    onClick={() =>
                                                        setExpandedBookingId(isExpanded ? null : booking.id.toString())
                                                    }
                                                ...
                                                >
                                                    ...
                                                    <img
                                                        src="/images/see.png"
                                                        className={`inline-block w-4 h-4 transition-transform ${isExpanded ? "rotate-180" : ""}`}
                                                        alt="Arrow"
                                                    />
                                                </div>
                                            )}
                                                ...
                                                >
                                                    <div className="mt-[23px] border-t border-[#DCDFE3]">
                                                        ...
                                                        <div className="mt-[12px]">
                                                            <h4 className="font-[400] text-[14px]">Meeting Description</h4>
                                                            <p className="text-[#A5A8B5] font-[400] text-[14px]">
                                                                A collaborative session to explore creative directions, review mockups, and align on visual goals for the upcoming product sprint. Bring your sketches, moodboards, and wild ideas!
                                                            </p>
                                                        </div>

                                                        {/* Team Members */}
                                                        <div>
                                                            <h4 className="font-[500] text-[14px] mb-[12px] mt-[50px]">Team members</h4>
                    ...
                    {activeTab === "Cancelled(5)" && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                            {bookings[activeTab].map((booking) => (
                                <div key={booking.id} className="relative px-[16px] py-[24px] border border-[#DCDFE3] rounded-[16px] space-y-2 ">
                                    {/* Cancelled badge */}
                                    ...
                                    <div className="block md:flex items-center justify-between">
                                        ...
                                        {booking.type === "room" && (
                                            <div className="text-[14px] mt-[20px] md:mt-0 flex gap-2 items-center font-[500] text-right text-[#134562] cursor-pointer">
                                                <span>See more</span>
                                                <img src="/images/see.png" className="inline-block w-4 h-4" alt="Arrow" />
                                            </div>
                                        )}
                    ...
                    {activeTab === "Past(10)" && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                            {bookings[activeTab].map((booking) => (
                                <div key={booking.id} className="relative border px-[16px] py-[24px] border-[#DCDFE3] rounded-[16px] bg-white">
                                    <div className="flex justify-between items-start mb-[25px]">
                                        <div >
                                            <h3 className="font-[600] text-[16px]">{booking.name}</h3>
                                            <p className="text-[14px] font-[400]">{booking.floor}</p>
